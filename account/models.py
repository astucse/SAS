...
class User(AbstractBaseUser):
    ...
    department=models.OneToOneField(Department,max_length=50,on_delete=models.CASCADE,default=True)
    school=models.OneToOneField(School,max_length=50,on_delete=models.CASCADE,default=True)
