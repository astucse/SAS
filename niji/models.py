...
def render_content(content_raw, sender):
    ...
    for user in mentioned_users:
        content_rendered = re.sub(
            ...
            partial(_replace_username, reverse('user_info', kwargs={"pk": user.pk})),
            content_rendered,
            re.M
        )
...
class Topic(models.Model):
    user = models.ForeignKey(USER_MODEL,on_delete=models.CASCADE,related_name='topics', verbose_name=_("user"))
    ...
    node = models.ForeignKey('Node',on_delete=models.CASCADE, related_name='topics', verbose_name=_("node"))
...
class Post(models.Model):
    topic = models.ForeignKey('Topic',on_delete=models.CASCADE, related_name='replies', verbose_name=_("topic"))
    user = models.ForeignKey(USER_MODEL,on_delete=models.CASCADE, related_name='posts', verbose_name=_("user"))
    content_raw = models.TextField(verbose_name=_("raw content"))
...
class Notification(models.Model):
    sender = models.ForeignKey(USER_MODEL,on_delete=models.CASCADE, related_name='sent_notifications', verbose_name=_("sender"))
    to = models.ForeignKey(USER_MODEL,on_delete=models.CASCADE, related_name='received_notifications', verbose_name=_("recipient"))
    topic = models.ForeignKey('Topic',on_delete=models.CASCADE, null=True, verbose_name=_("topic"))
    post = models.ForeignKey('Post',on_delete=models.CASCADE, null=True, verbose_name=_("reply"))
...
class ForumAvatar(models.Model):
    user = models.OneToOneField(USER_MODEL,on_delete=models.CASCADE, related_name='forum_avatar')
